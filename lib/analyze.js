    ...
    switch (tag.kind) {
      ...
      case 'function':
        ...
        fn.params.forEach(function(p) {
          // rename to force parameter description
          // being printed (ignoring function 
          // description)
          p.pDescription = p.description;
        ...
        fn.paramsString = fn.params
          // Only include top level parameters (no object properties)
          .filter(function(p) {
            return !p.nested;
          })
          .map(function(p) {
