...
function parseComments(ast) {
  var
    ...
    function fn() {
      // console.log("function:", inspect(arguments));

      // for (var i = 0; i < arguments[0].length; i++) {
      //   console.log("[0][" + i + "][0]", util.inspect(arguments[0][i], false, 20));
      //   // console.log("[0][" + i + "][1]", util.inspect(arguments[0][i], false, 20));
      // }
    ...
    function v() {
      // console.log("var:", inspect(arguments));
      // for (var i = 0; i < arguments[0].length; i++) {
      //   console.log("[0][" + i + "]", util.inspect(arguments[0][i], false, 20));
      //   if (arguments[0][i] && arguments[0][i].length) {
      //     console.log("[0][" + i + "][0]", util.inspect(arguments[0][i][0], false, 20)); // name?
      //     console.log("[0][" + i + "][1][0]", util.inspect(arguments[0][i][1][0], false, 20)); // name?
      //   }
      // }
      var comments = hasComments(arguments);
      if (comments) {
        ...
        if ((vv.length >= 3) && vv[0] === 'assign' && vv[3]) {
          ...
          for (var j = 0; j < vv.length; j++) {
            // console.log('name:', vv[j][0]);
            // console.log('function:', vv[j][1][0], vv[j][1].comments_before);
    ...
    function stat() {
      // console.log("stat:", inspect(arguments));
      // for (var i = 0; i < arguments[0].length; i++) {
      //   console.log("[0][" + i + "]", util.inspect(arguments[0][i], false, 20));
      //   if (arguments[0][i] && arguments[0][i].length) {
      //   }
    ...
    function defun() {
      // console.log("defun:", inspect(arguments));
      // console.log(arguments[0]);
      // console.log(hasComments(arguments));
    ...
    function obj() {
      ...
      if (arguments[0] && arguments[0].length) {
        for (var i = 0; i < arguments[0].length; i++) {
          // console.log("[0][i]", util.inspect(arguments[0][i], false, 20));
          // console.log("[0][i][0]", util.inspect(arguments[0][i][0], false, 20));
          // console.log("[0][i][1]", util.inspect(arguments[0][i][1][0], false, 20));
          // console.log("[0][i].comments_before", util.inspect(arguments[0][i].comments_before, false, 20));
